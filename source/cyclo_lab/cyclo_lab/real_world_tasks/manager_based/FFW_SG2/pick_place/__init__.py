...
gym.register(
    id="Cyclo-Real-Mimic-Pick-Place-FFW-SG2-v0",
    entry_point="cyclo_lab.real_world_tasks.manager_based.FFW_SG2.pick_place.pick_place_mimic_env:FFWSG2PickPlaceMimicEnv",
    kwargs={
