...
FFW_BG2_CFG = ArticulationCfg(
    spawn=UsdFileCfg(
        usd_path=f"{CYCLO_LAB_ASSETS_DATA_DIR}/robots/FFW/FFW_BG2.usd",
...
FFW_BG2_WITHOUT_MIMIC_CFG.spawn.usd_path = f'{CYCLO_LAB_ASSETS_DATA_DIR}/robots/FFW/FFW_BG2_without_mimic.usd'
